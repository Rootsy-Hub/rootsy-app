...
export const workspaceTableLayoutListBodyScopeClass = cn(
  ...
  "[&_[data-slot=table-body]_[data-slot=table-row]:not([data-table-end])]:!h-14 [&_[data-slot=table-body]_[data-slot=table-row]:not([data-table-end])]:!max-h-14",
  "[&_[data-slot=table-body]_[data-slot=table-row]:not([data-table-end])_[data-slot=table-cell]]:!h-14 [&_[data-slot=table-body]_[data-slot=table-row]:not([data-table-end])_[data-slot=table-cell]]:!max-h-14 [&_[data-slot=table-body]_[data-slot=table-row]:not([data-table-end])_[data-slot=table-cell]]:box-border [&_[data-slot=table-body]_[data-slot=table-row]:not([data-table-end])_[data-slot=table-cell]]:!py-0",
