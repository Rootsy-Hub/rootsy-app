...
/** Papel de valle — blanco fijo. --color-elevada cambia en POS / html.dark. */
export const dataWorkspacePaperSurfaceClass = "bg-[var(--rootsy-blanco)]"
...
export const dataWorkspaceShellCard =
  "rounded-2xl border border-border/80 bg-[var(--rootsy-blanco)] shadow-sm"
...
export const dataWorkspaceEntityCardBadgeClass =
  "inline-flex items-center gap-1.5 rounded-lg border border-[var(--rootsy-bruma-200)] bg-[var(--rootsy-blanco)] px-2.5 py-1.5 rootsy-text-label text-[var(--rootsy-bruma-500)] shadow-xs [&_svg]:size-3.5 [&_svg]:text-[var(--rootsy-bruma-500)]"
...
export const dataWorkspaceEntityCardStatusClosedClass =
  "inline-flex shrink-0 items-center rounded-full border border-[var(--rootsy-bruma-200)] bg-[var(--rootsy-blanco)] px-2.5 py-1 rootsy-text-label text-[var(--rootsy-bruma-500)]"
...
export const dataWorkspaceEntityCardClass = cn(
  ...
  "border border-[var(--rootsy-bruma-200)] bg-[var(--rootsy-blanco)] shadow-sm",
...
export const dataWorkspaceEntityCardIsotypeClass =
  "flex size-11 shrink-0 items-center justify-center rounded-xl border border-[var(--rootsy-bruma-200)] bg-[var(--rootsy-blanco)] text-[var(--rootsy-bruma-500)] shadow-xs"
...
/** Empty de bloques — usar DataWorkspaceBlocksEmptyState. Tablas: DataWorkspaceTableEmptyMascot. */
export const dataWorkspaceBlocksEmptyStateClass =
  "rounded-xl border border-dashed border-[var(--rootsy-bruma-300)] bg-[var(--rootsy-blanco)] px-4 py-10 text-center font-canopy text-sm text-[var(--rootsy-bruma-500)]"
...
export const dataWorkspaceDetailCardClass = cn(
  "overflow-hidden rounded-[1.375rem] border border-[var(--rootsy-bruma-200)] bg-[var(--rootsy-blanco)]",
  rootsyElevationRaisedRestClass,
)
...
export const workspaceTablePlaceholderRowClass = cn(
  ...
  "bg-[var(--rootsy-blanco)] hover:bg-[var(--rootsy-blanco)] pointer-events-none",
)
...
export function workspaceTableBodyRowClassNames(
  ...
  return cn(
    ...
    index % 2 === 0 ? "bg-[var(--rootsy-blanco)]" : workspaceTableRowStripeClass,
    options?.selected &&
