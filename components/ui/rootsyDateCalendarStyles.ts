...
export const rootsyDateCalendarDayOverridesClass = cn(
  ...
  "[&_button[data-day][data-selected-single=true]]:!bg-[var(--rootsy-savia-600)] [&_button[data-day][data-selected-single=true]]:!text-[var(--rootsy-white)]",
  "[&_button[data-day][data-range-start=true]]:!bg-[var(--rootsy-savia-600)] [&_button[data-day][data-range-start=true]]:!text-[var(--rootsy-white)]",
  "[&_button[data-day][data-range-end=true]]:!bg-[var(--rootsy-savia-600)] [&_button[data-day][data-range-end=true]]:!text-[var(--rootsy-white)]",
  "[&_button[data-day][data-selected-single=true]:hover]:!bg-[var(--rootsy-savia-700)] [&_button[data-day][data-selected-single=true]:hover]:!text-[var(--rootsy-white)]",
  "[&_button[data-day][data-range-start=true]:hover]:!bg-[var(--rootsy-savia-700)] [&_button[data-day][data-range-start=true]:hover]:!text-[var(--rootsy-white)]",
  "[&_button[data-day][data-range-end=true]:hover]:!bg-[var(--rootsy-savia-700)] [&_button[data-day][data-range-end=true]:hover]:!text-[var(--rootsy-white)]",
...
export const rootsyDateCalendarCompactShellClass = cn(
  ...
  "[&_button[data-day][data-selected-single=true]:hover]:!text-[var(--rootsy-white)]",
  "[&_.rdp-outside_button[data-day]]:!text-[var(--rootsy-bruma-400)]",
