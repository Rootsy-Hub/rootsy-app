-- Idempotencia de cobro + permitir persistir `sales` en rootsy_apply_with_audit.
ALTER TABLE public.sales
  ADD COLUMN IF NOT EXISTS idempotency_key TEXT;

CREATE UNIQUE INDEX IF NOT EXISTS sales_pop_id_idempotency_key_uidx
  ON public.sales (pop_id, idempotency_key)
