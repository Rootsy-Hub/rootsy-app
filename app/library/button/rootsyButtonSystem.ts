...
export const ROOTSY_BUTTON_COLOR_TOKENS: ButtonColorToken[] = [
  ...
  {
    appearance: "default",
    role: "Secundario — contorno savia 700",
    tokens: [
      { label: "Fondo", token: "transparent", hex: "transparent" },
      { label: "Borde", token: "savia-700", hex: hx("savia", "700") },
      { label: "Hover", token: "savia-50", hex: hx("savia", "50") },
      { label: "Texto", token: "savia-700", hex: hx("savia", "700") },
    ],
  },
  {
    appearance: "subtle",
    ...
    tokens: [
      ...
      { label: "Texto", token: "bruma-700", hex: hx("bruma", "700") },
    ],
  },
  {
    appearance: "danger",
    role: "Destructivo — lava vivo + 950",
    tokens: [
      { label: "Fondo", token: "lava-500", hex: hx("lava", "500") },
      { label: "Hover", token: "lava-600", hex: hx("lava", "600") },
      { label: "Active", token: "lava-700", hex: hx("lava", "700") },
      { label: "Texto", token: "lava-950", hex: hx("lava", "950") },
    ],
  },
  {
    appearance: "link",
    role: "Enlace — savia profundo",
    tokens: [
      { label: "Default", token: "savia-700", hex: hx("savia", "700") },
      { label: "Hover", token: "savia-800", hex: hx("savia", "800") },
...
export const ROOTSY_BUTTON_APPEARANCES: ButtonAppearance[] = [
  ...
  },
  {
    ...
    rootsyClass: "borde savia-700 · texto savia-700 · hover savia-50",
    usage: "Acciones frecuentes que no son la CTA principal — exportar, duplicar, filtrar.",
    atlassianRule: "Menos prominente que primary; contorno profundo sobre Luz filtrada.",
  },
  {
    id: "subtle",
    appearance: "subtle",
  ...
  },
  {
    ...
    rootsyClass: "bg lava-500 · texto lava-950 · hover lava-600",
  ...
  },
  {
    ...
    rootsyClass: "texto lava-700 · hover lava-50",
  ...
  },
  {
    ...
    natureName: "Enlace",
    rootsyVariant: "link",
    rootsyClass: "texto savia-700 · hover savia-800",
