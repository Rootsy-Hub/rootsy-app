...
export const SOMBRA_FAMILY: NatureFamily = {
  ...
  description:
    "Carbón verdoso — no gris de oficina ni tierra cálida. El fondo es siempre 950, el paso más oscuro. Cards y slots se elevan encima. Continuidad con marketing y profundidad savia.",
  steps: [
    ...
    { id: "z700", label: "700", hex: hx("sombra", "700"), usage: "Capas internas del dosel." },
    { id: "z600", label: "600", hex: hx("sombra", "600"), usage: "Superficie — panel sobre el fondo." },
    { id: "z500", label: "500", hex: hx("sombra", "500"), usage: "★ Elevada — card y slot." },
