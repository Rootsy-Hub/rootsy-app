    ...
    <ConceptBrumaStage caption="Card monolito blanco sobre bruma — un dato principal, metadatos discretos y savia solo en la acción.">
      <div className="flex min-h-[200px] items-center justify-center">
        <ConceptWhiteCard className="w-full max-w-sm">
          ...
          <p className="text-3xl font-semibold tracking-tight" style={{ color: CONCEPT_TOKENS.bruma900 }}>
            $ 48.320
          </p>
          <p className="mt-1 text-sm" style={{ color: CONCEPT_TOKENS.bruma500 }}>
      ...
      <div className="grid grid-cols-3 gap-2 sm:grid-cols-6">
        {CONCEPT_PALETTE_DEMO.map((swatch) => (
          <div key={swatch.label} className="space-y-2">
            ...
            />
            <div>
              <p className="text-[11px] font-semibold text-foreground">{swatch.label}</p>
  ...
  return (
    <ConceptBrumaStage caption="Lista con pocas columnas — nombre, contexto y monto. La fila activa se marca con savia, sin decoración extra.">
      <ConceptWhiteCard className="p-0 overflow-hidden">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-wide" style={{ color: CONCEPT_TOKENS.bruma500 }}>
            Tu pedido
          </p>
        </div>
        <ul>
          {CONCEPT_LIST_ITEMS.map((item, index) => (
            ...
            >
              <div className="min-w-0">
                <p className="truncate text-sm font-medium" style={{ color: CONCEPT_TOKENS.bruma900 }}>
                  {item.name}
                </p>
              ...
              <p className="shrink-0 text-sm font-semibold tabular-nums" style={{ color: CONCEPT_TOKENS.bruma900 }}>
                {item.price}
              </p>
            </li>
          ))}
...
export function ConceptButtonsDemo() {
  return (
    <ConceptWhiteCard>
      <p className="mb-4 text-sm font-medium" style={{ color: CONCEPT_TOKENS.bruma900 }}>
        Confirmar venta
      </p>
      ...
      <p className="mt-4 text-xs leading-relaxed" style={{ color: CONCEPT_TOKENS.bruma500 }}>
  ...
  return (
    <ConceptWhiteCard>
      <label className="block space-y-2">
        <span className="text-sm font-medium" style={{ color: CONCEPT_TOKENS.bruma900 }}>
          Nombre del artículo
        </span>
        <input
          readOnly
        ...
        />
        <span className="block text-xs" style={{ color: CONCEPT_TOKENS.bruma500 }}>
...
export function ConceptTypeScaleDemo() {
  return (
    <ConceptWhiteCard className="space-y-4">
      <div>
        <p className="text-lg font-semibold tracking-tight" style={{ color: CONCEPT_TOKENS.bruma900 }}>
          Ventas de hoy
        </p>
        <p className="mt-1 text-sm" style={{ color: CONCEPT_TOKENS.bruma600 }}>
          Resumen del turno · actualizado hace 5 min
        </p>
      </div>
      <p className="text-sm leading-relaxed" style={{ color: CONCEPT_TOKENS.bruma900 }}>
        Doce ventas cerradas con un ticket promedio saludable. Los productos de panadería
        concentran el volumen de la mañana.
      </p>
      <p className="text-xs uppercase tracking-wide" style={{ color: CONCEPT_TOKENS.bruma500 }}>
        Última venta · 09:42 · Medialuna x2
      </p>
      <p className="text-xs leading-relaxed" style={{ color: CONCEPT_TOKENS.bruma500 }}>
        Título → contexto → cuerpo → metadato. Proporciones que respiran, sin mezclar pesos al azar.
      </p>
    </ConceptWhiteCard>
  )
}
  ...
  return (
    ...
    >
      <div className="flex min-h-[240px] overflow-hidden rounded-xl">
        ...
        >
          <p className="mb-3 px-2 text-[10px] font-bold uppercase tracking-wider text-[#94A3B8]">
            Mostrador
          </p>
        ...
        <div className="min-w-0 flex-1 p-4" style={{ backgroundColor: CONCEPT_TOKENS.bruma100 }}>
          <ConceptWhiteCard>
            ...
            <p className="mt-1 text-xs" style={{ color: CONCEPT_TOKENS.bruma500 }}>
              3 ítems · mesa 4
            </p>
            <div
            ...
            >
              <span className="text-sm" style={{ color: CONCEPT_TOKENS.bruma900 }}>
                Total
              </span>
              <span className="text-sm font-semibold tabular-nums" style={{ color: CONCEPT_TOKENS.bruma900 }}>
                $ 8.500
              </span>
            </div>
            <button
...
export function ConceptEmptyStateDemo() {
  return (
    <ConceptWhiteCard className="flex min-h-[180px] flex-col items-center justify-center text-center">
      ...
      <p className="mt-1 max-w-[220px] text-xs leading-relaxed" style={{ color: CONCEPT_TOKENS.bruma500 }}>
      ...
      <p className="mt-4 text-[11px] leading-relaxed" style={{ color: CONCEPT_TOKENS.bruma500 }}>
