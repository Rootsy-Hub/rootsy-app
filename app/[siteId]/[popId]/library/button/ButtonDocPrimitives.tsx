...
export function ButtonRelatedLinks({ siteId, popId }: { siteId: string; popId: string }) {
  return <LibraryRelatedLinks siteId={siteId} popId={popId} links={BUTTON_RELATED_LINKS} />
}
