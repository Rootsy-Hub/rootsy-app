...
} from "@/app/[siteId]/[popId]/library/text-component/TextComponentSections"
...
export function TextComponentFoundationView({ sectionId, siteId, popId }: Props) {
  let content: ReactNode = null

  switch (sectionId) {
    case "component-text":
      content = <TextComponentOverviewSection siteId={siteId} popId={popId} />
      break
