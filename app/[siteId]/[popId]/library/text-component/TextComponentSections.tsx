...
} from "@/app/[siteId]/[popId]/library/text-component/TextComponentDocPrimitives"
import { getTextComponentPageMeta } from "@/app/[siteId]/[popId]/library/text-component/textComponentLibraryNav"
import {
...
} from "@/app/[siteId]/[popId]/library/text-component/rootsyTextComponentSystem"
...
export function TextComponentOverviewSection({ siteId, popId }: SectionProps) {
    ...
    <LibrarySection id={meta.id} title={meta.title} description={meta.description}>
      <div className="space-y-10">
        ...
        <TextComponentDocSection id="text-related" title="Fundamentos relacionados">
          <TextComponentRelatedLinks siteId={siteId} popId={popId} excludeId="component-text" />
        </TextComponentDocSection>
      </div>
    </LibrarySection>
  )
