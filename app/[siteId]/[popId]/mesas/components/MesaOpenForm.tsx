...
export function MesaOpenForm({
  ...
  return (
    ...
    >
          ...
          <div className="min-w-0 flex-1">
            ...
            >
              <SelectTrigger
                ...
                className={cn(
                  mesaFormFieldClass,
                  "mt-2 h-11 w-full font-normal data-placeholder:text-slate-400",
                )}
              >
                <SelectValue
                  placeholder={
      ...
      <div
        className={cn(
          "mt-auto grid gap-0 border-t border-slate-200/90",
      ...
      >
        ...
        <Button
          ...
          className={cn(
            "h-12 rounded-none bg-emerald-600 text-white hover:bg-emerald-700",
            !onCancel && "col-span-1",
          )}
        >
          {submitting ? "Guardando…" : submitLabel}
          {mergedIds.length > 0 ? ` (${tableIds.length} mesas)` : null}
        </Button>
      </div>
    </form>
  )
