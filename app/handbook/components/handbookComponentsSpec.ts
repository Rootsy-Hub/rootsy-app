 ...
 * Los especímenes vivos viven en HandbookComponentsSpecimens.
  ...
  navegacion: {
    ...
    principles: [
      ...
      },
      {
        ...
        detail: "DataWorkspaceSidebar lista las vistas del módulo. El menú del header cambia de vista sin salir.",
      },
      {
        title: "No hay migas",
...
> = {
  navegacion: [
    ...
    },
    {
      ...
      title: "Menús",
      description:
        "Cambio de vista desde el header. El trigger muestra la vista activa; el panel lista el resto.",
      token: "DataWorkspaceSectionMenu",
      doText: "El menú de sección cambia de vista sin salir del módulo.",
      dontText: "No pongas un select nativo en el header para navegar.",
      status: "live",
    },
    {
      id: "tabs",
      title: "Tabs",
      description:
        "Tesorería usa el Tabs de shadcn una vez. El resto elige con el rail o con RootsFormSegmentField.",
      token: "Tabs",
      doText: "Elegí rail, menú de sección o RootsFormSegmentField.",
      dontText: "No instales un tab bar genérico en un módulo nuevo.",
      status: "live",
    },
    {
      id: "breadcrumbs",
