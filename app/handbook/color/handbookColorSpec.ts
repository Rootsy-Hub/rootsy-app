...
export const HANDBOOK_ATMOSPHERE_CONTEXTS: {
  ...
  },
  {
    ...
    body: "Módulos operativos, concentración y densidad. El tope es negro. El 950 es aire. La hoja es 800.",
    cta: "Acción activa",
  },
]
...
export const HANDBOOK_ATMOSPHERE_TOKENS: HandbookAtmosphereToken[] = [
  {
    ...
    steps: { eter: "950", bruma: "100", sombra: "negro" },
  },
  {
    id: "superficie",
    token: "--color-superficie",
    label: "Superficie",
    purpose: "Panel o aire. En Sombra es 800 — la hoja. El 950 queda como pozo.",
    steps: { eter: "800", bruma: "50", sombra: "800" },
  },
  {
    id: "elevada",
    token: "--color-elevada",
    label: "Elevada",
    purpose: "Card sobre la superficie. En Luz filtrada es blanco. En Sombra la card es 800, la misma hoja.",
    steps: { eter: "700", bruma: "blanco", sombra: "800" },
  },
  {
    id: "borde",
    token: "--color-borde",
    label: "Borde",
    purpose: "Divisor y contorno. En Sombra el trazo de card y slot es 700.",
    steps: { eter: "700", bruma: "200", sombra: "700" },
  },
  {
    id: "texto",
    token: "--color-texto",
...
export const HANDBOOK_FUNCTIONAL_APPLICATION_RULES = [
  ...
  "En Sombra, savia solo en oficio: nav activo, CTA, + de card, ícono de slot cargado. No pinta precio, valor, meta ni hover de control.",
...
export const HANDBOOK_CONTRAST_PASS: HandbookContrastPair[] = [
  ...
  {
    id: "sombra-texto",
    label: "Sombra 50 sobre 800",
    context: "Título de producto en el catálogo.",
    foreground: { familyId: "sombra", step: "50" },
    background: { familyId: "sombra", step: "800" },
    ratio: "15.1:1",
    level: "AAA",
  },
  {
    id: "sombra-muted",
    label: "Sombra 300 sobre 800",
    context: "Metadatos de card y labels inactivos del rail.",
...
export const HANDBOOK_CONTRAST_RULES = [
  ...
  "En Sombra el vacío es negro. El 950 no entra como fondo de canvas.",
